...
if __name__ == '__main__':
    ...
    classical = ~table['Has_optical_hydrogen']
    ...
    plot_stars(m1[classical&superhumps], m2[classical&superhumps], m2_err[classical&superhumps], p[classical&superhumps], \
                                        colour='grey', marker='o', label='Superhumps')
    ...
    plot_stars(m1[~classical], m2[~classical], m2_err[~classical], p[~classical], \
                                        colour='m', marker='D', label='Hydrogen')
